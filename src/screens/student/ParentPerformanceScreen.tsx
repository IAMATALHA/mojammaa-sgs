                ...
                <View style={styles.recapRow}>
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={{
                      ...
                      <Text style={{ color: theme.textSoft, fontFamily: theme.fonts.medium, fontSize: 16 }}>
                        {' '}/ 20
                      </Text>
                    </Text>
                  </View>
                  <View style={[styles.rankBadge, { backgroundColor: theme.primarySurface }]}>
                    ...
                    <Text style={{ color: theme.primary, fontFamily: theme.fonts.bold, fontSize: 14, marginTop: 4 }}>
                      {report.rank}
                    </Text>
                    <Text style={{ color: theme.primary, fontFamily: theme.fonts.medium, fontSize: 9.5, letterSpacing: 0.5 }}>
                      {t('parent.rank')}
                    </Text>
                  </View>
                </View>
