...
const THEME: Theme = {
  ...
  geminiBlue:     palette.geminiBlue,
  geminiPurple:   palette.geminiPurple,
  geminiCyan:     palette.geminiCyan,
  geminiSurface:  palette.geminiSurface,
  geminiBorder:   palette.geminiBorder,
